...
namespace WebApplication6.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> RegisterCoordinator(RegisterBindingModel model)
        {
            ...
            //assume that the role:Admin is already created
            UserManager.AddToRole(user.Id, "Coordinator");
            return Ok();
        }
        // POST api/Account/RegisterSupervisor
        //[Authorize(Roles ="Supervisor")]
        [AllowAnonymous]

        [Route("RegisterSupervisor")]
        public async Task<IHttpActionResult> RegisterSupervisor(RegisterBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
